...
class HomeViewState extends State<HomeView> {
  ...
  Future<void> inputStock() async {
              ...
              TextButton(
                ...
                onPressed: () async {
                  if (stockSymbol.isNotEmpty) {
                    ...
                    try {
                      //TODO:
                      var companyData = await stockService.getCompanyInfo(stockSymbol);
                      print(companyData);
                      var quoteData = await stockService.getQuote(stockSymbol);
                      print(quoteData['Symbol']);
                      print(companyData['Name']);
                      if (companyData == null || quoteData == null) {
                        print('failed to get company data or quote data');
                      } else {
    ...
    // void updateUI(dynamic stockData, dynamic quoteData) {
    //   if(stockData != null) {
    //    double price = quoteData[] 
    //   }
